...
namespace TeleportLocations
{
	namespace IplNames
	{
		const std::vector<const char*> vYacht_Smboat1
		{
			{ "smboat" },
			{ "smboat_lod" }
		};
		const std::vector<const char*> vYacht_Heist1
		{
			//{ "smboat_lod" },
			{ "hei_yacht_heist" },
		...
		const std::vector<const char*> vYacht_Heist2
		{
			//{ "gr_grdlc_yacht_lod" },
		...
		const std::vector<const char*> vAircraftCarrier1
		{
			{ "hei_carrier" },
		...
		const std::vector<const char*> vNorthYankton
		{
			//{ "prologue_m2_door" },
		...
		const std::vector<const char*> vAllCustomisableApartments1
		{
			{ "apa_v_mp_h_01_a" },
			{ "apa_v_mp_h_01_c" },
			{ "apa_v_mp_h_01_b" },
		...
		const std::vector<const char*> vAllOffices1
		{
		...
		const std::vector<const char*> vAllOfficeGarages1
		{
...
#pragma region interiors
		const std::vector<TeleLocation> vInteriors
		{
			...
			TeleLocation("Casino Vault", 2517.84f, -238.99f, -70.56f),
			TeleLocation("Casino Room 1", 2509.71, -225.32, -70.61),
			TeleLocation("Casino Room 2", 2520.31, -220.68, -70.57),
			TeleLocation("Casino Room 3", 2533.85, -225.23, -70.6),
			TeleLocation("Casino Room 4", 2538.47, -237.82, -70.4),
			TeleLocation("Casino Room 5", 2534.36, -251.02, -70.77),
			TeleLocation("Casino Room 6", 2520.02, -255.4, -70.54),
			TeleLocation("Casino Room 7", 2508.23, -250, -70.68),*/
